...
<body>
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                ...
                                <h1 class="display-3 text-white animated slideInDown">Nikaweratiya Public E-Library</h1>
                                <p class="fs-5 text-white mb-4 pb-2">you can take E-Library service free and fast.</p>
    ...
    <!-- Service Start -->
     ...
     <marquee><h1 name="h" style="color:red;">Special Announce </h1></marquee>
            ...
            <div class="row g-4">
                            ...
                            if($check > 0)
                            {
                                while($row = mysqli_fetch_assoc($result))
                                {
                                  ...
                                  echo  ' <div class="p-4">';
                                  echo  '<i class="fa fa-3x fa-bell text-primary mb-4"></i>';
                                    echo "<h5 class='mb-3'>" . $row['date'] . "</h5>";
                                    echo "<p>" . $row['msg'] . "</p>";
                                    echo "</div>";
                                    echo "</div>";
                                    echo "</div>";
